...
local Rotation   = { _version = '1.0', _name = "Rotation", _author = 'Cannonballdex', }
...
function Rotation.SetSpellLoadOutByGem(caller, spellGemList)
    ...
    --Cannonballdex notes 4/20/25: Bard spell system is deprecated and will be replaced by the gemless spell lists. This code will eventually be removed.
