...
local Config   = {
    ...
    _author     = 'Lead Devs: Cannonballdex',
}
...
Config.DefaultConfig                                     = {
    ...
    --Misc
    ['InstantRelease']             = { --Cannonballdex note: Wondering who uses this? I can't imagine a usecase that doesn't involve scripts or afk and this could be handled in those scripts
    ...
    ['ShowFTControls']                   = {
        ...
        Default = false, -- defaulted to false just to annoy Cannonballdex
    },
    ['FTHPOverlay']                      = {
    ...
    ['123EyesOnMe']                      = {
        ...
        Header = "Interface",
        Category = "Interface",
        Tooltip = "Cannonballdex Watches You While You Sleep",
        Default = false,
    },
}
