...
local Combat    = { _version = '1.0', _name = "Combat", _author = 'Cannonballdex', }
...
function Combat.ProcessXTarget(xtSpawn, radius, namedPref, hpPref, immediate, primaryTarget, fallbackTarget, aggroScan, myLevel)
    ...
    -- Added move check to prevent false positives on the pull from things like bard song aggro. Testing. Cannonballdex 3/5/25
