...
function UnitTests.RunAll()
    ...
    do
        ...
        assertEq("IsTempPet: apostrophe s Pet", Targeting.IsTempPet(petSpawn("Cannonballdex's Pet")), true)
        assertEq("IsTempPet: backtick s Pet", Targeting.IsTempPet(petSpawn("Cannonballdex`s Pet")), true)
