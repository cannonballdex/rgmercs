...
function Module:Render()
    ...
    if ImGui.BeginTable("ExpStats", 2, bit32.bor(ImGuiTableFlags.Borders)) then
        ...
        ImGui.TableNextColumn()
        ImGui.Text("%2.3f%%", self.TrackXP.Experience.Total / self.TrackXP.XPTotalDivider)
        ImGui.TableNextColumn()
        ImGui.Text("AA Gained")
        ImGui.TableNextColumn()
        ImGui.Text("%2.3f%%", self.TrackXP.AAExperience.Total / self.TrackXP.XPTotalDivider)
        ImGui.TableNextColumn()
        ImGui.Text("Exp / Min")
        ImGui.TableNextColumn()
        ImGui.Text("%2.3f%%", self.XPPerSecond * 60)
        ImGui.TableNextColumn()
        ImGui.Text("Exp / Hr")
        ImGui.TableNextColumn()
        ImGui.Text("%2.3f%%", self.XPPerSecond * 3600)
        ImGui.TableNextColumn()
        ImGui.Text("Time To Level")
        ImGui.TableNextColumn()
        ImGui.Text(tostring(self.TimeToLevel))
        ImGui.TableNextColumn()
        ImGui.Text("AA / Min")
        ImGui.TableNextColumn()
        ImGui.Text("%2.3f%%", ((self.TrackXP.AAExperience.Total / self.TrackXP.XPTotalDivider) / (os.clock() - self.TrackXP.StartTime)) * 60)
        ImGui.EndTable()
    end
