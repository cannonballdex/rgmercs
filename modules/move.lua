...
local Module    = { _version = '0.1a', _name = "Movement", _author = 'Cannonballdex', }
    ...
    if Config:GetSetting('ChaseOn') and Config:GetSetting('ChaseTarget') then
        ...
        if Config:GetSetting('UseActorNav') then
            ...
            if data and data.Zone == mq.TLO.Zone.Name() and data.X and data.Y and data.Z then
                ...
                -- Cannonballdex note: Emu server code seems to give constant updates up to 300, and periodic updates up to 600. Over 600, stops updating. Tested on EQMight 11/2025
        ...
        if chaseSpawnDist > chaseDist then
            ...
            elseif chaseSpawnDist < 400 then -- Cannonballdex note I left this alone, legacy code, not sure if this value is signifigant or arbitrary
