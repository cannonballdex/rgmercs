                    ...
                    if corpsename == groupcorpsename then
                        if mq.TLO.Spawn('id '..corpseid).Distance() >= mindistance then
                                if not mq.TLO.Spawn(groupmember).Dead() then
                                    ...
                                    mq.delay(2000)
                                if mq.TLO.Me.Class.ShortName() == 'SHD' and mq.TLO.Me.AltAbilityReady('Summon Remains')() then
                                    mq.cmd('/alt act 7007')
                                end
                                if mq.TLO.Me.Class.ShortName() == 'NEC' and mq.TLO.Me.AltAbilityReady('Summon Remains')() then
                                    mq.cmd('/alt act 7002')
                                end
                            end
                        end
