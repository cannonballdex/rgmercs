...
-- Safe level helper so Defaults never evaluate nil at load time
local function safeLevel()
    local lvl = mq.TLO.Me.Level()
    return (type(lvl) == "number" and lvl > 0) and lvl or 125
end
...
local _ClassConfig = {
    ...
    ['RotationOrder']     = {
        ...
        { --Actions to lock down xtarg haters
            ...
            cond = function(self, combat_state)
                ...
                -- including nearby non-grouped peers via Peer Aggro Scan) runs every tick regardless
                -- of our own combat_state, so a valid AggroTargetID is reason enough to act even if
                -- combat_state hasn't flipped to "Combat" yet.
    ...
    ['DefaultConfig']     = {
        ...
        ['Timer5Choice']      = {
            ...
            Default = safeLevel() < 99 and 1 or 3,
            Min = 1,
            Max = 4,
            ConfigType = "Advanced",
        },
        ...
        ['DoTouchHeal']       = {
            ...
            Default = safeLevel() > 72 and 3 or 2,
            Min = 1,
            Max = 3,
        },
        ['DoLightHeal']       = {
