...
return {
    ...
    -- 1.4 Added toggle for Disconcering Disc, Fixed errors in burn phase with minor refactors --Cannonballdex

    _author           = "Cannonballdex, SCVOne",
    ['Modes']         = {
        'DPS',
    },
    ['ItemSets']      = {
    ...
    ['Rotations']     = {
        ...
        ['Burn'] = { --This really needs to be refactored with helper functions sometime. Other prioriities atm. Cannonballdex 3/2/25
            {
